...
class Model:
    ...
    def _load(self):
        ...
        try:
            ...
            logger.info(f"Loaded embedding model: {self.name}")
    ...
    def _inspect(self):
        ...
        backend = getattr(self._hf, "client", None) or self._hf._client
    ...
    def info(self) -> dict:
        ...
        return {
            ...
            "params": self.params,
            "backend": type(
                getattr(self._hf, "client", None) or self._hf._client
            ).__name__,
        }
